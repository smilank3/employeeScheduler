...
A preference-based weekly shift scheduling system. This is desktop app built with Python and Tkinter.
...
## Requirements
  - Python 3.0 or later
  - Tkinter (standard Python installs, no external installation required in windows )
